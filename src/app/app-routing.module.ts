...
},
{
  ...
  {
    path: 'tourist/login',
    loadChildren: () => import('./tourist/login/login.module').then( m => m.LoginPageModule)
  },
  {
    path: 'tourist/register',
    loadChildren: () => import('./tourist/register/register.module').then( m => m.RegisterPageModule)
  },
  {
    path: 'tourist/activity-operator-list/:activityId',
    loadChildren: () => import('./tourist/activity-operator-list/activity-operator-list.module').then(m => m.ActivityOperatorListPageModule)
  },
{
  ...
  },
  {
    ...
    loadChildren: () => import('./tourist/confirm-booking-details/confirm-booking-details.module').then( m => m.ConfirmBookingDetailsPageModule)
  },
  {
    path: 'tourist/accommodation-booking',
    loadChildren: () => import('./tourist/accommodation-booking/accommodation-booking.module').then( m => m.AccommodationBookingPageModule)
  },
  {
